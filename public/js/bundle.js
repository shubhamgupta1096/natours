...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoic2h1YmhhbWd1cHRhMTA5NiIsImEiOiJja293c2t3azIwMjM4MnFtYzc2dGI4Mm40In0.8mrHfjGWm2zA-E3fvps8qQ';
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, ": ").concat(loc.description, "</p>")).addTo(map); //Extend the map to include the current locations
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            stripe = Stripe('pk_test_51Iuh7QSJ95lnCZRcwaMx8XILYU5rxh32YUesfUBTO2ow6HD5m7O6kBfWFolj1Sai3BQOWK95EMyvGQGcmknJqYGD00V7xprdbh'); //1. Get the session from the API
          ...
          case 4:
            ...
            console.log(session); //2.Create the checkout form + charge the credit card for us
...
if (bookBtn) {
  bookBtn.addEventListener('click', function (e) {
    e.target.textContent = 'Processing....'; // const tourID = e.target.dataset.tourId; //tour-id of the dataset is converted automatically to camelCase
